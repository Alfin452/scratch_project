<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-2xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Edit Subbab (Materi)') }} - {{ $subModule->module->title }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700">
                <div class="p-8">
                    ...
                    <form action="{{ route('sub_modules.update', $subModule->id) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                            <div class="col-span-3">
                                ...
                                <input type="text" name="title" id="title" value="{{ old('title', $subModule->title) }}" required
                            ...
                            <div class="col-span-1">
                                ...
                                <input type="number" name="order" id="order" value="{{ old('order', $subModule->order) }}" required
                        ...
                        <div>
                            ...
                            <textarea name="content" id="content" class="hidden">{!! old('content', $subModule->content) !!}</textarea>
                        </div>

                        <div class="flex items-center justify-end space-x-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                            <a href="{{ route('modules.show', $subModule->module_id) }}" class="px-5 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-600 transition">
                                Batal
                            </a>
