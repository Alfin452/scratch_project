<x-app-layout>
    ...
    <style>
        /* Konfigurasi Tinggi Editor */
        .ck-editor__editable_inline {
            min-height: 400px;
        }

        /* Konfigurasi Dark Mode untuk Editor Area */
        ...
        /* Dukungan Spasi Paragraf CKEditor */
        ...
        .dark .ck.ck-editor__main>.ck-editor__editable p {
            ...
            .create(document.querySelector('#content'), {
                toolbar: {
                    items: [
                        ...
                        'uploadImage', 'blockQuote', 'insertTable', 'link', '|',
                        'undo', 'redo'
                    ],
