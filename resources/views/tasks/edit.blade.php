<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div x-data="editDecomposition({{ json_encode($task->content) }})" class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
        ...
        {{-- === EDIT FORM DRAG & DROP === --}}
        <div x-data="editDragDrop({{ json_encode($task->content) }})" class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
